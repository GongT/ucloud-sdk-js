...
export default class UDiskClient extends Client {
	...
	attachUDisk(request?: AttachUDiskRequest): Promise<AttachUDiskResponse> {
		...
		return this.invoke(new Request(args)).then(resp => resp.toObject() as AttachUDiskResponse);
	}
	...
	cloneUDisk(request?: CloneUDiskRequest): Promise<CloneUDiskResponse> {
		...
		return this.invoke(new Request(args)).then(resp => resp.toObject() as CloneUDiskResponse);
	}
	...
	cloneUDiskSnapshot(request?: CloneUDiskSnapshotRequest): Promise<CloneUDiskSnapshotResponse> {
		...
		return this.invoke(new Request(args)).then(resp => resp.toObject() as CloneUDiskSnapshotResponse);
	}
	...
	cloneUDiskUDataArk(request?: CloneUDiskUDataArkRequest): Promise<CloneUDiskUDataArkResponse> {
		...
		return this.invoke(new Request(args)).then(resp => resp.toObject() as CloneUDiskUDataArkResponse);
	}
	...
	createAttachUDisk(request?: CreateAttachUDiskRequest): Promise<CreateAttachUDiskResponse> {
		...
		return this.invoke(new Request(args)).then(resp => resp.toObject() as CreateAttachUDiskResponse);
	}
	...
	createUDisk(request?: CreateUDiskRequest): Promise<CreateUDiskResponse> {
		...
		return this.invoke(new Request(args)).then(resp => resp.toObject() as CreateUDiskResponse);
	}
	...
	createUDiskSnapshot(request?: CreateUDiskSnapshotRequest): Promise<CreateUDiskSnapshotResponse> {
		...
		return this.invoke(new Request(args)).then(resp => resp.toObject() as CreateUDiskSnapshotResponse);
	}
	...
	deleteUDisk(request?: DeleteUDiskRequest): Promise<DeleteUDiskResponse> {
		...
		return this.invoke(new Request(args)).then(resp => resp.toObject() as DeleteUDiskResponse);
	}
	...
	deleteUDiskSnapshot(request?: DeleteUDiskSnapshotRequest): Promise<DeleteUDiskSnapshotResponse> {
		...
		return this.invoke(new Request(args)).then(resp => resp.toObject() as DeleteUDiskSnapshotResponse);
	}
	...
	describeRecycleUDisk(request?: DescribeRecycleUDiskRequest): Promise<DescribeRecycleUDiskResponse> {
		...
		return this.invoke(new Request(args)).then(resp => resp.toObject() as DescribeRecycleUDiskResponse);
	}
	...
	describeUDisk(request?: DescribeUDiskRequest): Promise<DescribeUDiskResponse> {
		...
		return this.invoke(new Request(args)).then(resp => resp.toObject() as DescribeUDiskResponse);
	}
	...
	describeUDiskPrice(request?: DescribeUDiskPriceRequest): Promise<DescribeUDiskPriceResponse> {
		...
		return this.invoke(new Request(args)).then(resp => resp.toObject() as DescribeUDiskPriceResponse);
	}
	...
	describeUDiskSnapshot(request?: DescribeUDiskSnapshotRequest): Promise<DescribeUDiskSnapshotResponse> {
		...
		return this.invoke(new Request(args)).then(resp => resp.toObject() as DescribeUDiskSnapshotResponse);
	}
	...
	describeUDiskUpgradePrice(request?: DescribeUDiskUpgradePriceRequest): Promise<DescribeUDiskUpgradePriceResponse> {
		...
		return this.invoke(new Request(args)).then(resp => resp.toObject() as DescribeUDiskUpgradePriceResponse);
	}
	...
	detachUDisk(request?: DetachUDiskRequest): Promise<DetachUDiskResponse> {
		...
		return this.invoke(new Request(args)).then(resp => resp.toObject() as DetachUDiskResponse);
	}
	...
	recoverUDisk(request?: RecoverUDiskRequest): Promise<RecoverUDiskResponse> {
		...
		return this.invoke(new Request(args)).then(resp => resp.toObject() as RecoverUDiskResponse);
	}
	...
	renameUDisk(request?: RenameUDiskRequest): Promise<RenameUDiskResponse> {
		...
		return this.invoke(new Request(args)).then(resp => resp.toObject() as RenameUDiskResponse);
	}
	...
	resizeUDisk(request?: ResizeUDiskRequest): Promise<ResizeUDiskResponse> {
		...
		return this.invoke(new Request(args)).then(resp => resp.toObject() as ResizeUDiskResponse);
	}
	...
	restoreUDisk(request?: RestoreUDiskRequest): Promise<RestoreUDiskResponse> {
		...
		return this.invoke(new Request(args)).then(resp => resp.toObject() as RestoreUDiskResponse);
	}
	...
	setUDiskUDataArkMode(request?: SetUDiskUDataArkModeRequest): Promise<SetUDiskUDataArkModeResponse> {
		...
		return this.invoke(new Request(args)).then(resp => resp.toObject() as SetUDiskUDataArkModeResponse);
	}
}
